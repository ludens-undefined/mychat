...
type School struct {
	...
	Longitude string `orm:"column:longitude;size:32"` //经
	Latitude  string `orm:"column:latitude;size:32"` //纬
...
func (t *School) TableName() string {
	return "goouc_xmf_school"
}
...
// Id doesn't exist
func GetSchoolById(id int) (v *School, err error) {
	o := orm.NewOrm()
	v = &School{Id: id}
...
// UpdateSchool updates School by Id and returns error if
