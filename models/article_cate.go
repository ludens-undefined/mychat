...
func (t *ArticleCate) TableName() string {
	return "goouc_xmf_article_cate"
}
...
// Id doesn't exist
func GetArticleCateById(id int) (v *ArticleCate, err error) {
	o := orm.NewOrm()
	v = &ArticleCate{Id: id}
...
func DeleteArticleCate(id int) (err error) {
	o := orm.NewOrm()
	v := ArticleCate{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
